...
class _CreatePostState extends State<CreatePost> {
  ...
  final Post post = new Post(); // Post object
  List<Post> postListData = PostsRepository.allPosts; // Post list data
                      ...
                      Container(
                        child: MultiSelect(
                          ...
                          onSaved: (value) {
                            ...
                            post.tags = this.tagsDropdownValue;
                          },
                        ),
                      ),
